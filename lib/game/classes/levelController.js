    ...
    ig.LevelController = ig.Class.extend({
        ...
        loadLevelfromURL: function() {
            if (this.isValid(ig.game.level)) {
                ...
                ig.game.inGameGUIController.toggleUI( true );
                console.log(ig.game.getEntitiesByType(EntityEventTrigger));
            }
        },
        ...
        loadNPCEntities: function() {
            if (this.currentLevel == '1_House_UpperFloor') {
                ...
                var spawnpointToaster1 = ig.game.getEntityByName('toasterSpawn_1');
                var entityToaster1 = ig.game.spawnEntity(EntityToaster, spawnpointToaster1.pos.x, spawnpointToaster1.pos.y, {name: 'SecurityBot 00000'});
                entityToaster1.speed = 100;

                var spawnpointToaster2 = ig.game.getEntityByName('toasterSpawn_2');
                var entityToaster2 = ig.game.spawnEntity(EntityToaster, spawnpointToaster2.pos.x, spawnpointToaster2.pos.y, {name: 'SecurityBot 00001'});
                entityToaster2.speed = 100;

                var spawnpointToaster3 = ig.game.getEntityByName('toasterSpawn_3');
                var entityToaster3 = ig.game.spawnEntity(EntityToaster, spawnpointToaster3.pos.x, spawnpointToaster3.pos.y, {name: 'SecurityBot 00010'});
                entityToaster3.speed = 100;

                var spawnpointToaster4 = ig.game.getEntityByName('toasterSpawn_4');
                var entityToaster4 = ig.game.spawnEntity(EntityToaster, spawnpointToaster4.pos.x, spawnpointToaster4.pos.y, {name: 'SecurityBot 00011'});
                entityToaster4.speed = 100;

                var spawnpointToaster5 = ig.game.getEntityByName('toasterSpawn_5');
                var entityToaster5 = ig.game.spawnEntity(EntityToaster, spawnpointToaster5.pos.x, spawnpointToaster5.pos.y, {name: 'SecurityBot 00100'});
                entityToaster5.speed = 100;

                var spawnpointToaster6 = ig.game.getEntityByName('toasterSpawn_6');
                var entityToaster6 = ig.game.spawnEntity(EntityToaster, spawnpointToaster6.pos.x, spawnpointToaster6.pos.y, {name: 'SecurityBot 00101'});
                entityToaster6.speed = 100;

                var spawnpointToaster7 = ig.game.getEntityByName('toasterSpawn_7');
                var entityToaster7 = ig.game.spawnEntity(EntityToaster, spawnpointToaster7.pos.x, spawnpointToaster7.pos.y, {name: 'SecurityBot 00111'});
                entityToaster7.speed = 100;

                var spawnpointToaster8 = ig.game.getEntityByName('toasterSpawn_8');
                var entityToaster8 = ig.game.spawnEntity(EntityToaster, spawnpointToaster8.pos.x, spawnpointToaster8.pos.y, {name: 'SecurityBot 01000'});
                entityToaster8.speed = 100;

                var spawnpointToaster9 = ig.game.getEntityByName('toasterSpawn_9');
                var entityToaster9 = ig.game.spawnEntity(EntityToaster, spawnpointToaster9.pos.x, spawnpointToaster9.pos.y, {name: 'SecurityBot 01001'});
                entityToaster9.speed = 100;

                var spawnpointToaster10 = ig.game.getEntityByName('toasterSpawn_10');
                var entityToaster10 = ig.game.spawnEntity(EntityToaster, spawnpointToaster10.pos.x, spawnpointToaster10.pos.y, {name: 'SecurityBot 01010'});
                entityToaster10.speed = 100;

                var spawnpointToaster11 = ig.game.getEntityByName('toasterSpawn_11');
                var entityToaster11 = ig.game.spawnEntity(EntityToaster, spawnpointToaster11.pos.x, spawnpointToaster11.pos.y, {name: 'SecurityBot 01011'});
                entityToaster11.speed = 100;

                var spawnpointToaster12 = ig.game.getEntityByName('toasterSpawn_12');
                var entityToaster12 = ig.game.spawnEntity(EntityToaster, spawnpointToaster12.pos.x, spawnpointToaster12.pos.y, {name: 'SecurityBot 01100'});
                entityToaster12.speed = 100;

                var spawnpointToaster13 = ig.game.getEntityByName('toasterSpawn_13');
                var entityToaster13 = ig.game.spawnEntity(EntityToaster, spawnpointToaster13.pos.x, spawnpointToaster13.pos.y, {name: 'SecurityBot 01101'});
                entityToaster13.speed = 100;

                var spawnpointToaster14 = ig.game.getEntityByName('toasterSpawn_14');
                var entityToaster14 = ig.game.spawnEntity(EntityToaster, spawnpointToaster14.pos.x, spawnpointToaster14.pos.y, {name: 'SecurityBot 01110'});
                entityToaster14.speed = 100;

                var spawnpointToaster15 = ig.game.getEntityByName('toasterSpawn_15');
                var entityToaster15 = ig.game.spawnEntity(EntityToaster, spawnpointToaster15.pos.x, spawnpointToaster15.pos.y, {name: 'SecurityBot 01111'});
                entityToaster15.speed = 100;

                var spawnpointToaster16 = ig.game.getEntityByName('toasterSpawn_16');
                var entityToaster16 = ig.game.spawnEntity(EntityToaster, spawnpointToaster16.pos.x, spawnpointToaster16.pos.y, {name: 'SecurityBot 10000'});
                entityToaster16.speed = 100;

                var spawnpointToaster17 = ig.game.getEntityByName('toasterSpawn_17');
                var entityToaster17 = ig.game.spawnEntity(EntityToaster, spawnpointToaster17.pos.x, spawnpointToaster17.pos.y, {name: 'SecurityBot 10001'});
                entityToaster17.speed = 100;

                var spawnpointToaster18 = ig.game.getEntityByName('toasterSpawn_18');
                var entityToaster18 = ig.game.spawnEntity(EntityToaster, spawnpointToaster18.pos.x, spawnpointToaster18.pos.y, {name: 'SecurityBot 10010'});
                entityToaster18.speed = 100;

                var spawnpointToaster19 = ig.game.getEntityByName('toasterSpawn_19');
                var entityToaster19 = ig.game.spawnEntity(EntityToaster, spawnpointToaster19.pos.x, spawnpointToaster19.pos.y, {name: 'SecurityBot 10011'});
                entityToaster19.speed = 100;

                var spawnpointToaster20 = ig.game.getEntityByName('toasterSpawn_20');
                var entityToaster20 = ig.game.spawnEntity(EntityToaster, spawnpointToaster20.pos.x, spawnpointToaster20.pos.y, {name: 'SecurityBot 1010'});
