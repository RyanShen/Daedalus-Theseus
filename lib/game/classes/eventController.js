        ...
        ig.EventController = ig.Class.extend({
            ...
            event_LevelOne_FatherGetsKidnapped: function (eventTrigger) {
                ...
                this.eventChain = EventChain(this)
                    ...
                    {
                        var dialogSetJSON = [
                            { name: 'Father', side: 'right', mediaNum: 1, autoprogress: 0, text: 'Wow '+ ig.game.dialogController.avatar[ig.game.avatarID].nickname +'! Just completed another CTF?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 7, autoprogress: 0, text: 'Yup! Piece of cake!' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: 0, autoprogress: 0, text: '<Received Flash Drive from Dad.>' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 6, autoprogress: 0, text: 'What\'s up dad? Why are you talking weird?' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, autoprogress: 0, text: 'Dad.. Whats going on?' },
                            { name: 'Father', side: 'right', mediaNum: 1, autoprogress: 0, text: 'Son. Stay here and be quiet. I\'ll answer the door.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, autoprogress: 0, text: 'Dad!' }
                        ];
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Huh? Dad?' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Oh my god. Dad!' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'I have to find out what\'s going on downstairs!' }
                        ];
                        this.dialogBox.playDialogSet( dialogSetJSON );
            ...
            event_LevelOne_PlayerLooksForFather: function () {
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ig.game.player.setMovementLock(true);
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'It sounded like it came from the front door. I should go there.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelOne_PlayerDecidesToInvestigateFlashDrive: function () {
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ig.game.player.setMovementLock(true);
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Dad\'s not here! What\'s going on?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Who were those people?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Where did they take Dad?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: '...' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Wait.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Maybe it has something to do with this flash drive...' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'I should check it out on my computer.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelOne_PlayerAccessesFlashDrive: function () {
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ig.game.player.setMovementLock(true);
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Dad must have given me this software for a reason.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'I remember him showing me some of his work in his room before.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 8, text: 'I might be able to find some clues there.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelOne_PoliceArrives: function () {
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ig.game.player.setMovementLock(true);
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'A cyborg!? Is this what Dad has been working on?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'And who are these people he\'s been talking to on email?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Are these the same people who took him?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'This is too confusing. I better go to the police.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
                    ...
                    {
                        var dialogSetJSON = [
                            { name: 'Police Officer', side: 'right' , mediaNum: 3, text: 'ARE YOU ig.game.dialogController.avatar[ig.game.avatarID].name DANSON?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Ye..yes? What\'s going on officer? Why are you here?' },
                            { name: 'Police Officer', side: 'right' , mediaNum: 3, text: 'We are looking for your father, Edwin Danson! WHERE IS HE?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'He\'s not here..' },
                            { name: 'Police Officer', side: 'right' , mediaNum: 3, text: 'WHAT!? Stop lying boy! We know he\'s here. TELL US WHERE IS HE HIDING!' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Some people came and took him away just now..' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'I was just about to call the police when you guys showed up.' },
                    ...
                    {
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'WAIT! Can you tell me what is going on!?' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'That\'s not possible! My dad will never do such a thing.' },
                    ...
                    {
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'WAIT! Is this about the cyborg!?' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'I.. I.. I was looking through my dad\'s stuff and I found a blueprint of it.' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Well... I\'m kinda just good at this stuff...' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Of.. OF COURSE!' },
                    ...
                    {
                        var dialogSetJSON = [
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 0, text: 'Look\'s like I don\'t have a choice. I have to save Dad.' }
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: 10, text: 'Let\'s go save my dad' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelOne_Chat: function () {
                var parameters = {text: 'I fucking pwn. period.', tracks: ig.game.dialogController.avatar[ig.game.avatarID].nameson
                    , margin: 0, lifeSpan: 5, shape: 'rounded', name: 'playerBubble', color:[255,255,255], opacity: 1};
