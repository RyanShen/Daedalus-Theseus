...
ig.module(
    ...
    .defines( function(){
        ...
        EntityAchievements = ig.Entity.extend({
            ...
            glowTrophy: new ig.AnimationSheet('media/UI/InGame/IG_glow_achievements.png',100,100),
            fontText: new ig.Font('media/Fonts/viewer_content.png'),
            ...
            trophyAngle: 0,
            trophyScale: 1,
            trophyDestinationX: 120,
            trophyDestinationY: 20,
            achText:null,
            achTextWrapWidth:0,
            achTextWidth:0,
            achTextheight:0,
            ...
            init: function(x,y,settings){
                ...
                this.lastAnimationCycle = new ig.Animation(this.animSheetAchievementUnlocked,1,[71],true );
                ...
                this.reverseAnimationCycle = new ig.Animation(this.animSheetAchievementUnlocked,1,[71],true );
                ...
                this.animGlow = new ig.Animation(this.glowTrophy,1,[0],true );
            ...
            update:function(){
                ...
                if( ig.input.pressed('up') )
                    //this.displayAchievement( 1, 1, 1, 1, 1);
                switch( this.stateAnimation )
                {
                    ...
                    case 'disappearing':
                        ...
                        if( this.trophyTimer >= 0 )
                        {
                            ...
                            this.trophyX += (this.trophyDestinationX - this.trophyX)/5;
                            this.trophyY += (this.trophyDestinationY - this.trophyY)/5;
                    ...
                    case 'trophyanim':
                        ...
                        if( this.animGlow.alpha > 0 )
                        {
                            this.animGlow.alpha -= 0.005;
                        }
                        break;
                    case 'hidden':
                        break;
            ...
            draw:function(){
                ...
                switch( this.stateAnimation )
                {
                    ...
                    case 'trophy':
                        ...
                        this.fontText.draw(this.TextWrap("Click to continue",200),this.achTextWidth,540,ig.Font.ALIGN.CENTER);
                        break;
                    case 'stay':
                        this.animAchievementBlackBar.draw( 0 , 0);
                        this.lastAnimationCycle.draw(0, this.achTextheight-95);
            ...
            drawTrophy: function( scale, angle, x, y ){
                ...
                else
                {
                    ...
                    ctx.save();
                    ctx.translate( ig.system.getDrawPos( x ),
                        ig.system.getDrawPos( y ) );
                    ctx.scale( scale, scale );
                    this.animCurTrophy.angle = angle;
                    this.animCurTrophy.draw( -116, 10 );
                    ctx.restore();
                }
            },
