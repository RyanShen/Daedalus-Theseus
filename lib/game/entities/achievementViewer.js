ig.module(
    ...
    'impact.entity'
        ...
        EntityAchievementViewer = ig.Entity.extend({
            ...
            titleFont: new ig.Image('media/Fonts/achievement_title.png'),
            ...
            list:[
                ...
                {title: '1 KNOW IT ALL', type: 'bronze', content: 'Solved all trivia questions'},
                {title: '2 FORENSIC MASTERY', type: 'silver', content: 'Solved 3 forensic questions'},
                {title: '3 JACK OF ALL TRADES', type: 'bronze', content: 'Solved questions of 4 different categories'},
                {title: '4 JACK OF ALL TRADES', type: 'bronze', content: 'Solved questions of 4 different categories'},
                {title: '5 JACK OF ALL TRADES', type: 'bronze', content: 'Solved questions of 4 different categories'},
                {title: '6 JACK OF ALL TRADES', type: 'bronze', content: 'Solved questions of 4 different categories'},
                {title: '7 JACK OF ALL TRADES', type: 'bronze', content: 'Solved questions of 4 different categories'}
            ],
            ...
            draw: function() {
                if (this.show) {
                    ...
                    for (i = 0; i < 7; i++) {
                        ...
                        ctx.closePath();
                        ctx.restore();
                        this.contentFont.draw(this.solveCount[i] + "/" + this.typeCount[i], 865, y + 5);
                    ...
                    // draw back button
                    ig.gui.element.action('show', 'Button_Back');
                }
            },
            ...
            initBackButton: function() {
                ig.gui.element.add({
                    ...
                    click: function() {
                        ig.gui.element.action('hide', 'Button_Back');
