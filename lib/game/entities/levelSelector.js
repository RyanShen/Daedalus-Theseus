...
.defines(function(){
    ...
    EntityLevelSelector = ig.Entity.extend({
        ...
        countFont: new ig.Image('media/Fonts/problemtrigger_light.png'),
        ...
        update: function() {
            if(this.visible)
            {
                ...
                var alpha = ig.gui.element.action('getByName', 'LS_Button_Close').alpha;
                if( alpha < 0.9 )
                {
        ...
        display: function() {
            ...
            if (this.levelsUnlocked >= 1) {
                ...
                this.solveCount[0] = count;
            }

            for (i = 0; i < 5; i++) {
                console.log(this.solveCount[i]);
            }
        },
        ...
        draw: function() {
            if (this.visible) {
                ...
                if (this.levelsUnlocked >= 5) {
                    ...
                    this.countFont.draw(this.solveCount[4] + "/70", 695 , 165);
                }
                if (this.levelsUnlocked >= 4) {

                    this.countFont.draw(this.solveCount[3] + "/5", 710, 351);
                }
                if (this.levelsUnlocked >= 3) {

                    this.countFont.draw(this.solveCount[2] + "/3", 710, 539);
                }
                if (this.levelsUnlocked >= 2) {

                    this.countFont.draw(this.solveCount[1] + "/8", 270, 407);
                }
                if (this.levelsUnlocked >= 1) {

                    this.countFont.draw(this.solveCount[0] + "/7", 215, 146);
                }
            }
        },
