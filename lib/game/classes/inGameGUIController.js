...
.defines(function(){ "use strict";
    ...
    ig.InGameGUIController = ig.Class.extend({
        ...
        draw: function() {
            ...
            if ( this.showObjectiveBox && this.showUI )
            {
                //this.objectiveText = this.TextWrap('Look for your father downstairs.', 22);
        ...
        updateObjectives: function(eventID) {
            ...
            switch (eventID){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    this.objectiveText = this.TextWrap('Use the computer in your room to investigate the flash drive.', wrapWidth);
                    break;
                case 4:
                    this.objectiveText = this.TextWrap('Investigate your \nfather\'s room for more clues.', wrapWidth);
                    break;
                case 5:
                    this.objectiveText = this.TextWrap('Go to the front door to leave for the Police HQ when you are ready.', wrapWidth);
                    break;
                case 7:
                    this.objectiveText = this.TextWrap('Help police officers retrieve information from the pieces of evidence they are working on.', wrapWidth);
                    break;
                case 8:
                ...
                case 10:
                    ...
                    break;
                case 11:
                    this.objectiveText = this.TextWrap('Hack into the lift\'s security system.', wrapWidth);
                    break;
                default:
        ...
        TextWrap: function( text, width ){
            ...
            while( index < words.length )
            {
                ...
                lineWidth += words[index].length + 1;
                if( lineWidth >= width )
                {
                    newText += '\n';
                    newText += words[index];
