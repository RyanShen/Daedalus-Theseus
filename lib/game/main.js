    ...
    .defines(function(){
        ...
        MyGame = ig.Game.extend({
            ...
            init: function() {
                ...
                ig.input.bind( ig.KEY.K, 'skip' );
                ig.input.bind( ig.KEY.NUMPAD_0, 'zero' );
                ig.input.bind( ig.KEY.NUMPAD_1, 'one' );
                ig.input.bind( ig.KEY.NUMPAD_2, 'two' );
                ig.input.bind( ig.KEY.NUMPAD_3, 'three' );
                ig.input.bind( ig.KEY.NUMPAD_4, 'four' );
