...
EntityNPC = EntityWalker.extend({
    ...
    init: function( x, y, settings ) {
        ...
        //animation
        this.animSheet = new ig.AnimationSheet( 'media/Characters/' + settings.media + '.png', 87.5, 161 );
        ...
        this.addAnim( 'walk_l', this.animInterval*1.2, [24,25,26,27,28,29,30,31] );
        //up-left
        ...
        this.addAnim( 'walk_r', this.animInterval*1.2, [48,49,50,51,52,53,54,55] );
        //up-right
    ...
    setCharacter: function( media, name ) {

        this.name = name;

        //animation
        this.animSheet = new ig.AnimationSheet( 'media/Characters/' + media + '.png', 87.5, 161 );
