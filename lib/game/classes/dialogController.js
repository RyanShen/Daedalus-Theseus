...
.defines(function(){
    ...
    DialogController = ig.Class.extend({
        ...
        init: function() {
            ...
            this.dialogSetJSON= [{id: 1, content: [
                { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_happy, text: 'Hmm I managed to fix it. Maybe I could put into Dad\'s PC later.' }
            ]},
                {id: 2, content: [
            ...
            console.trace(ig.game.dialogFigures.f_happy);
        },
