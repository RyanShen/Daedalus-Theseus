...
.defines(function(){ "use strict";
    ...
    ig.EventController = ig.Class.extend({
        ...
        startEvent: function (eventTrigger) {
            ...
            switch (eventTrigger.eventID){
                ...
                case 13:
                    ...
                    break;
                case 14:
                    this.event_LevelFour_PlayerEntersSecretRooms(eventTrigger);
                    break;
                case 15:
                    this.event_LevelFour_PlayerCompletesGame(eventTrigger);
                    break;
                default :
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Father', side: 'right', mediaNum: ig.game.dialogFigures.f_dad, autoprogress: 0, text: 'It contains a very important piece of software. You have to keep it safe. Promise me that.' },
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_shock, autoprogress: 0, text: 'Are you serious!? My dad would never do such a thing!' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'We seized a bunch of evidence from his office but the problem is some of the files are either corrupted or encrypted.' },
        ...
        event_LevelTwo_PlayerGathersEnoughEvidence: function () {
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'I think I\'ve gathered enough evidence.' },
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'Good. Let\'s go find Steve. I want to hear what you have found too.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_dilemma, autoprogress: 0, text: 'Well... It seems like everything points to some organization named Daedalus Corp.' },
                        ...
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: '<phone rings>' },
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'The phone call came from a subsidiary of Thyrin Lab - Crete Industries.' },
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'Yes Sir.' },
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_shock, autoprogress: 0, text: 'Uhh... What are those?' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
        ...
        event_LevelThree_PlayerDefeatsBoss: function () {
            ...
            var prompt = ig.game.spawnEntity(EntityInGamePrompt, 0, 0);
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_cheerful, autoprogress: 0, text: 'I\'ll come too!' },
                ...
                {
                    ig.game.toggleEventModeInteraction(true);
                    ig.game.levelController.changeLevelWithSpecificSpawnPoint('4_Tower_SecretFloor', 'eventSpawn');
                    ig.game.inGameGUIController.updateObjectives(this.latestEventID);
                    this.ends = true;
                    ig.game.eventID = this.latestEventID;
...
//                        ig.game.toggleEventModeInteraction(false);
        ...
        event_LevelFour_PlayerEntersSecretRooms: function () {
            this.dialogBox = ig.game.getEntitiesByType(EntityDialogPlayer)[0];
            this.camera = ig.game.levelController.camera;
            this.ends = false;
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var officerLisaWalkDestination = ig.game.getEntityByName('lisaWalkDestination');
                    policeOfficerLisa.setDestination(officerLisaWalkDestination.pos.x, officerLisaWalkDestination.pos.y);
                    var officerSteveWalkDestination = ig.game.getEntityByName('steveWalkDestination');
                    policeOfficerSteve.setDestination(officerSteveWalkDestination.pos.x, officerSteveWalkDestination.pos.y);
                    var police1WalkDestination = ig.game.getEntityByName('police1_WalkDestination');
                    policeman1.setDestination(police1WalkDestination.pos.x, police1WalkDestination.pos.y);
                    var police2WalkDestination = ig.game.getEntityByName('police2_WalkDestination');
                    policeman2.setDestination(police2WalkDestination.pos.x, police2WalkDestination.pos.y);
                    var playerWalkDestination = ig.game.getEntityByName('playerWalkDestination');
                    ig.game.player.setDestination(playerWalkDestination.pos.x, playerWalkDestination.pos.y);
                })
                ...
                {
                    var dialogSetJSON = [
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'Look at this place' },
                        { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Seems like we have a lot of ground to cover.' },
                        { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: ig.game.dialogController.avatar[ig.game.avatarID].name +', let\'s investigate the rooms and see what we can find.' },
                        { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_cheerful, autoprogress: 0, text: 'Ok.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
...
//                        ig.game.toggleEventModeInteraction(false);
        ...
        event_LevelFour_PlayerCompletesGame: function () {
            this.dialogBox = ig.game.getEntitiesByType(EntityDialogPlayer)[0];
            this.camera = ig.game.levelController.camera;
            this.ends = false;
