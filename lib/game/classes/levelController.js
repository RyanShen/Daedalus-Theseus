        ...
        drawLevelNameSplash: function() {
            switch(this.currentLevel){
                case '1_House_UpperFloor':
                    this.currentLevelName = 'Home\n(Upper Floor)';
                    break;
                case '1_House_GroundFloor':
                    this.currentLevelName = 'Home\n(Ground floor)';
                    break;
                case '2_PoliceHQ_GroundFloor':
                    this.currentLevelName = 'Police\nHeadquarters';
                    break;
                case '3_Tower_GroundFloor':
                    this.currentLevelName = 'Crete Tower\n(Ground Floor)';
                    break;
