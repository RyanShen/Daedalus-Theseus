ig.module(
    ...
    .defines(function() {
        EntityQuestionController = ig.Entity.extend({
            ...
            checkEvent: function() {
                if (this.state === 0) {
                    if (this.questionNum >= 18) {
                        this.state = 4;
                    }
                    else if (this.questionNum >= 12) {
                        this.state = 3;
                    }
                ...
                if (this.state === 1) {
                    ...
                    if (this.toaster1 && this.isSolved(1, 11, 11)) {
                        bot1.die();
                        this.toaster1 = false;
                    }
                    else if (this.toaster2 && this.isSolved(1, 12, 12)) {
                        bot2.die();
                        this.toaster2 = false;
                    }
                    else if (this.toaster3 && this.isSolved(1, 13, 13)) {
                        bot3.die();
                        this.toaster3 = false;
                    }
