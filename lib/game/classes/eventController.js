    ...
    .defines(function(){ "use strict";
        ...
        ig.EventController = ig.Class.extend({
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'The phone call came from a subsidiary of Thryin Lab - Crete Induestries.' },
            ...
            event_LevelThree_PlayerArrivesAtCreteRoboticsTower: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        police[4].setDestination(police4WalkDestination.pos.x, police4WalkDestination.pos.y);
                        var police6WalkDestination = ig.game.getEntityByName('police2_walkDestination_1');
                        police[3].setDestination(police6WalkDestination.pos.x, police6WalkDestination.pos.y);
                        var police2WalkDestination = ig.game.getEntityByName('police3_walkDestination_1');
                        police[1].setDestination(police2WalkDestination.pos.x, police2WalkDestination.pos.y);
                        var police1WalkDestination = ig.game.getEntityByName('police4_walkDestination_1');
                        police[0].setDestination(police1WalkDestination.pos.x, police1WalkDestination.pos.y);
                        var police3WalkDestination = ig.game.getEntityByName('police5_walkDestination_1');
                        police[2].setDestination(police3WalkDestination.pos.x, police3WalkDestination.pos.y);
                        var police5WalkDestination = ig.game.getEntityByName('police6_walkDestination_1');
                        police[5].setDestination(police5WalkDestination.pos.x, police5WalkDestination.pos.y);
                    })
                    .wait(1)
                    .then(function ()
                    {
                    ...
                    {
                        var dialogSetJSON = [
                            { name: 'Security Bot 17', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'Defensive Mode Activated.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelThree_PlayerHacksElevator: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Hmm.. Seems like they put a security lock on the elevator. We can\'t get in.' },
            ...
            event_LevelThree_PlayerEntersBossRoom: function () {
                ...
                var police = ig.game.getEntitiesByType('EntityNPC');
                var policeman1 = police[2];
                var policeman2 = police[3];
                ...
                this.eventChain = EventChain(this)
                    ...
                    {
                        var dialogSetJSON = [
                            { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'Woah. What is this place?' },
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: 'Lilian', side: 'right' , mediaNum: ig.game.dialogFigures.f_lilian, autoprogress: 0, text: 'Isn\'t it magnificant?' },
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Theseus.. Daedalus.. Labyrinth.. Minotaur.. I GET IT NOW!' },
