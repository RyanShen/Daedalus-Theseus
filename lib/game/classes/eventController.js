        ...
        ig.EventController = ig.Class.extend({
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'It seems to be able to analyse objects that are either corrupted or locked under a security system.' },
            ...
            event_LevelThree_PlayerEntersBossRoom: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    .waitUntil(function ()
                    {
                        return !this.dialogBox.isPlaying && lilian.hasReachedDestination;
                    })
                    .then(function ()
                    {
            ...
            event_LevelThree_PlayerDefeatsBoss: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    {
                        ig.game.toggleEventModeInteraction(true);
                        //ig.game.levelController.changeLevel('3_Tower_SecretFloor');
                        ig.game.inGameGUIController.updateObjectives(this.latestEventID);
                        this.ends = true;
                        ig.game.eventID = this.latestEventID;
