...
EntityDialogBox = ig.Entity.extend({
    ...
    setSide: function( side ) {
        ...
        if( side == 'left' )
        {
            this.paddingX = 95;
            this.paddingY = 64;
            this.lineWidthMax = 48;
        }
        else if( side == 'right' )
        {
            this.paddingX = 55;
            this.paddingY = 64;
            this.lineWidthMax = 45;
        }
        else
        {
            this.paddingX = 55;
            this.paddingY = 35;
            this.lineWidthMax = 55;
        }
                ...
                while( true )
                {
                    if( this._indexChar >= this.textPoolArray[this._indexArray].length )
                    {
                        ...
                        if( this._indexArray < this.textPoolArray.length )
                        {
                            ...
                            this._lineWidthCurrent += this.textPoolArray[this._indexArray].length+1;
                            if( this._lineWidthCurrent > this.lineWidthMax )
                            {
                                //start new line or clear all text
                                ...
                                this._lineWidthCurrent = 0;//this._context.measureText( this.textPoolArray[this._indexArray] + ' ').width;
                            }
                            else
                            {
                                this.textCurrent += ' ';
