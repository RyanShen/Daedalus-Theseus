...
.defines(function(){ "use strict";
    ...
    ig.LevelController = ig.Class.extend({
        ...
        levelNameFont: new ig.Font('media/levelSplashFont.png'),
        ...
        loadNewGameLevel: function() {
            ...
            ig.game.spawnEntity(EntityNPC, 800, 544, {name: 'Dad', media: 'Father'});
            ...
            switch(ig.game.eventController.latestEventID){
                ...
                case 5:
                    if (this.currentLevel == '1_House_GroundFloor'){
                        ig.game.spawnEntity(EntityNPC, 750, 950, {name:'Police Officer Lisa', media:'Lisa'});
                        ig.game.spawnEntity(EntityNPC, 850, 950, {name:'Police Officer Steve', media:'Steve'});
                    }
                    break;
                default :
