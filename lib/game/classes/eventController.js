            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'WHAT!? Stop lying boy! TELL US WHERE IS HE HIDING!' },
        ...
        event_LevelTwo_PlayerArrivesAtPoliceHQ: function () {
            ...
            this.eventChain = EventChain(this)
                ...
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_dilemma, autoprogress: 0, text: 'I have to do this quickly... I need to save my Dad.' },
        ...
        event_LevelTwo_PlayerGathersEnoughEvidence: function () {
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'I think I\'ve gathered enough evidences.' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'I should report my findings to Section Chief Steve right away.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'Huh?' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'Yeah. Somewhat..' },
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_dilemma, autoprogress: 0, text: 'Well.. It seems like everything points to same organization named Daedalus Corp.' },
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'I don\'t really have a choice, do I?' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: '<phone ring>' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Oh? My phone is ringing.' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Hmm it\'s an unknown number.' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Hello?' },
                        { name: 'Unknown', side: 'right' , mediaNum: ig.game.dialogFigures.f_EMPTY, autoprogress: 0, text: 'Where is the flash drive?' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'WHO IS THIS!? WHAT HAVE YOU DONE WITH MY DAD!?' },
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: '!!!' },
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisae, autoprogress: 0, text: 'Let me try to trace the call. Justin keep them on the phone.' },
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
                ...
                {
                    var dialogSetJSON = [
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'I have the flash drive with me. Let me talk to my dad!' },
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'I want to talk to my Dad!' },
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Where am I suppose to meet you?!' },
                        { name: 'Unknown', side: 'right' , mediaNum: ig.game.dialogFigures.f_EMPTY, autoprogress: 0, text: 'Your police friends will know.' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: '<phone line cuts>' },
                        { name: 'Justin', side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Hello!?' },
                        { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Sir. I\'ve triangulated the position. It\'s coming from a building a couple of blocks away.' },
