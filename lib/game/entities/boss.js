...
EntityBoss = EntityWalker.extend({
    ...
    bodyY: 0,
    timer: 0,
    stateAnimation: 'appearing', //appearing: stand on platform, ascending: ascending into midair, floating: float in the air
    isSuspended: false,
    ...
    draw: function() {
        ...
        switch( this.stateAnimation )
        {
            ...
            case 'floating':
                ...
                this.animFloating.draw( this.pos.x - ig.game.screen.x, this.bodyY - ig.game.screen.y );
