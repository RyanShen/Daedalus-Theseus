...
ig.Achievement = ig.Class.extend({
       ...
       Achievements:{
        ...
        6:{name:'ACH 6',type:'Bronze',desc:'Solved questions of 4 different categories'},
        7:{name:'ACH 7',type:'Gold',desc:'Test achievement 7'},
        8:{name:'ACH 8',type:'Silver',desc:'Test achievement 8'},
       ...
       update:function(){
           ...
           console.log("user name is" +ig.game.userID+ " team id is " +ig.game.teamID);
          ...
          // console.log("qs active " +this.isQsActive);
           if (this.timer.delta() >= 0) {
               ...
               * */
               this.processAchievements(3,2,3,4,5);
               //this.processAchievements(2,2,7,9);
               //this.processAchievements(3,3,2,4,5,12);
               /*
            ...
            for(var j = 0; j < this.teamMembers.length; j++){
                if(ig.game.userID == this.teamMembers[j].username){
                  var achievementDisplayed = this.teamMembers[j].adisplayed;
                    console.log("achievement displayed" +achievementDisplayed);
                   if( achievementDisplayed.indexOf(this.teamAchievements[i]) < 0){
                    // console.log( this.teamAchievements[i] + " " +this.Achievements[this.teamAchievements[i]].type +" " +this.Achievements[this.teamAchievements[i]].name);
                     ...
                     console.log("should update data loader now");
