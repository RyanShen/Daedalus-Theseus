...
EntityToaster = EntityWalker.extend({
    ...
    init: function( x, y, settings ) {
        ...
        this.question = ig.game.getEntityByName(this.question);
    ...
    update: function() {
        ...
        if (this.question && this.alive &&
            this.question.eventTriggered && this.question.solved &&
            !ig.game.getEntitiesByType(EntityQuestions)[0].isActive) {
            this.die();
            this.alive = false;
        }
    },
    ...
    draw: function() {
        ...
        switch( this.stateAnimation )
        {
            ...
            case 'dying':
                ...
                break;
            case 'dead':
                this.animBody.draw( this.pos.x - ig.game.screen.x, this.pos.y - 14 - ig.game.screen.y );
                break;
            default:
                break;
        }
