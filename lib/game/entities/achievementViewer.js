    ...
    'impact.entity'
        ...
        EntityAchievementViewer = ig.Entity.extend({
            ...
            list:[
                ...
                {title: 'KNOW IT ALL', content: 'Solved all trivia questions'},
                {title: 'FORENSIC MASTERY', content: 'Solved 3 forensic questions'},
                {title: 'JACK OF ALL TRADES', content: 'Solved questions of 4 different categories'}
            ],
