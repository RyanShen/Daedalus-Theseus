...
ig.Camera = ig.Class.extend({
	...
	follow: function( entity ) {
		this.pos.x = this.move( 'x', this.entityToFollow.pos.x, this.entityToFollow.size.x );
		this.pos.y = this.move( 'y', this.entityToFollow.pos.y, this.entityToFollow.size.y );
	...
	draw: function() {
        ...
        //console.trace(this.trap.pos.x + ":"+ this.trap.pos.y+ ":"+ this.trap.size.x+ ":"+ this.trap.size.y);
	}
});
