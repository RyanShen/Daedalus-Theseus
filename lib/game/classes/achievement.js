          ...
          // console.log("qs active " +this.isQsActive);
           if (this.timer.delta() >= 0) {
               ...
               * */
               ...
               this.processAchievements(3,1);
               this.processAchievements(4,2);
               this.processAchievements(2,3,2);
               this.processAchievements(5,1);
               this.processAchievements(6,2);
               this.processAchievements(7,1,3);
               this.processAchievements(8,2);
