...
MyGame = ig.Game.extend({
	...
	init: function() {
        ...
        this.avatarID = ig.game.dataLoader.getAvatarID();
        this.teamID = ig.game.dataLoader.getTeamID();
        this.eventID = ig.game.dataLoader.getEventID();
        this.level = ig.game.dataLoader.getLevel();
        this.pos = ig.game.dataLoader.getPosition();
