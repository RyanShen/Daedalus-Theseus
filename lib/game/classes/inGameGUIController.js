        ...
        updateObjectives: function(eventID) {
            ...
            switch (eventID){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    this.objectiveText = this.TextWrap('Use the computer on kitchen table to investigate the flash drive.', wrapWidth);
                    break;
                case 4:
                    this.objectiveText = this.TextWrap('Investigate upstairs for more clues.', wrapWidth);
                    break;
                case 5:
