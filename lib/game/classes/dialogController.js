...
.defines(function(){
    ...
    DialogController = ig.Class.extend({
        ...
        init: function() {
            ...
            this.dialogSetJSON= [
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                //LEVEL 1 - Questions and Interactive Object Dialogs
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {id: '1_upperFloor_Question6_Before', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'There must be some information among these documents.' }
                ]},
                {id: '1_upperFloor_Question6_After', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Just a bunch of robot blueprints from Dad\'s job at Thyrin Lab.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Why does he bring home so much of his work?' }
                ]},
                {id: '1_upperFloor_Question7_Before', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Maybe he has something in his bedside table.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Hmm... A CD.' }
                ]},
                {id: '1_upperFloor_Question7_After', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'There\'s an image folder called \"MINO-4\" in here.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Looks like parts of a robot of sorts.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Doesn\'t seem like the type of robots Dad usually builds.' }
                ]},
                ...
                {id: '1_upperFloor_Basketball', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'Used to play basketball with Dad when I was younger.' }
                ]},
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                //LEVEL 2 - Questions and Interactive Object Dialogs
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {id: '2_PoliceHQ_Question8_After', content: [
                    ...
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'Is that a client of Thyrin Lab\'s?' },
                ...
                {id: '2_PoliceHQ_Question11_Before', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Hey ' + this.avatar[ig.game.avatarID].name + ', got a second?' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_sincere, autoprogress: 0, text: 'Yep, sure!' }
                ]},
                {id: '2_PoliceHQ_Question11_After', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Oh! So that\'s how it\'s done.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Great job!' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'What are you guys working on here.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'We think Thyrin Lab is involved somehow, but we can\'t seem to find the link.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Hmm... Thyrin Lab...' }
                ]},
                {id: '2_PoliceHQ_Question12_Before', content: [
                ...
                {id: '2_PoliceHQ_Question12_After', content: [
                    ...
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Whatever it is, your father was working some kind of counter measure for it.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'I wonder if he completed it. Or was he kidnapped because of it!?' }
                ]},
                {id: '2_PoliceHQ_Question13_Before', content: [
                ...
                {id: '2_PoliceHQ_Question13_After', content: [
                ...
                {id: '2_PoliceHQ_Question14_Before', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'We\'re trying to get a log of all the phone calls from your Dad\'s office.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_sincere, autoprogress: 0, text: 'Sure, I\'ll take a look at it!' }
                ]},
                {id: '2_PoliceHQ_Question14_After', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'Alright!' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'Let\'s see what\'s in here.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'Hmm... All his calls in and out are internal.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'There\'s nothing suspicious in here at all.' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman3, autoprogress: 0, text: 'Strange.' }
                ]},
                {id: '2_PoliceHQ_Question15_Before', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman1, autoprogress: 0, text: 'I\'m stuck on this problem. Could you help me out?' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_sincere, autoprogress: 0, text: 'Sure, I\'ll give it a go!' }
                ]},
                {id: '2_PoliceHQ_Question15_After', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman1, autoprogress: 0, text: 'It\'s an audio log of your dad\'s.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"It\'s Day 90 of the project.\"' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"I think the superiors are on to me.\"' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"They\'ve started monitoring my work a lot closer.\"' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"I\'ve completed the counter measure, but I have not had the chance to test it.\"' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"Security around the cyborg is too tight.\"' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'noside' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: '\"Whatever it is, I have to hide this before they find out.\"' },
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman1, autoprogress: 0, text: 'What is this counter measure he is talking about?' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'I have no idea.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'Hmm...' }
                ]},
                {id: '2_PoliceHQ_Lisa', content: [
                    { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'What do you want, kid?' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_sincere, autoprogress: 0, text: 'Uhh just checking if you need my help.' },
                    { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'No, I don\'t.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'Oh okay...' }
                ]},
                {id: '2_PoliceHQ_Steve', content: [
                    { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'How\'s the progress on the evidence, ' + this.avatar[ig.game.avatarID].name + '?'},
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_sincere, autoprogress: 0, text: 'Still working on it!' },
                    { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'That\'s great! Keep it up!'}
                ]},
                ...
                {id: '2_PoliceHQ_Interrogation_Notes', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'Looks like the notes from my interrogation that Officer Lisa took just now.' }
                ]},
                ...
                {id: '2_PoliceHQ_Lobby_Policeman', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'How\'s the evidence coming along?' },
                ...
                {id: '2_PoliceHQ_Computer', content: [
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                //LEVEL 3 - Questions and Interactive Object Dialogs
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                {id: '3_Tower_Question16_Before', content: [
                    { name: 'Security Bot 17', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'Bzzz.' }
                ]},
                {id: '3_Tower_Question16_After', content: [
                    { name: 'Security Bot 17', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'System malfunction. Shutting down.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_cheerful, autoprogress: 0, text: 'Alright!' }
                ]},
                {id: '3_Tower_Question17_Before', content: [
                    { name: 'Security Bot 88', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'Bzzz.' }
                ]},
                {id: '3_Tower_Question17_After', content: [
                    { name: 'Security Bot 88', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'System malfunction. Shutting down.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_cheerful, autoprogress: 0, text: 'Oh yeah!' }
                ]},
                {id: '3_Tower_Question18_Before', content: [
                    { name: 'Security Bot 11', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'Bzzz.' }
                ]},
                {id: '3_Tower_Question18_After', content: [
                    { name: 'Security Bot 11', side: 'right' , mediaNum: ig.game.dialogFigures.f_toaster, autoprogress: 0, text: 'System malfunction. Shutting down.' },
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_cheerful, autoprogress: 0, text: 'Got it!' }
                ]},
                {id: '3_Tower_Plant', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'There is no sunlight here. How does the plant survive?' }
                ]},
                {id: '3_Tower_Computer', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'The computer is turned off. Seems like the place has been vacated.' }
                ]},
                {id: '3_Tower_Couch', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_serious, autoprogress: 0, text: 'This isn\'t the time to be sitting around.' }
                ]},
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                //LEVEL 4 - Questions and Interactive Object Dialogs
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                {id: '4_Tower_Plant', content: [
                    { name: this.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_disinterested, autoprogress: 0, text: 'These plants don\'t look so good.' }
                ]},
            ];
        },
