...
EntityWalker = ig.Entity.extend({
    ...
    //test whether the walker's current position is valid. return false if it is a collider
    validateCurrentPos: function(){

        return this.astar.validateTile( this.grid.getNodeByPosition( this.pos.x + this.size.x/2, this.pos.y + this.size.y/2 ) );
    },
