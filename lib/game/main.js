...
MyGame = ig.Game.extend({
	...
	update: function() {
        console.log("player:" + this.playerLock + "  ui: " + this.uiLock + "  problem: " + this.problemLock + "  clickable: " + this.clickableLock);
    ...
    toggleSubsystemsInteraction: function( toggle ) {
        ...
        this.toggleUIPlayerInteraction( toggle );
        this.toggleClickableInteraction(toggle);
        this.toggleProblemInteraction(toggle);
    }
});
