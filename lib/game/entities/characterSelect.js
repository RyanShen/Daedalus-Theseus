ig.module(
    ...
    .defines(function() {
        EntityCharacterSelect = ig.Entity.extend({
            ...
            playButton: null,
            confirmHover: new ig.Image('media/UI/Confirm.png'),
            confirm: new ig.Image('media/UI/ConfirmHover.png'),
            ...
            draw: function() {
                if (this.errorMessage != null)
                    this.font.draw(this.errorMessage, 500, 700, ig.Font.ALIGN.CENTER);
                switch (this.state) {
                    case 0:
                    case 1:
                    case 2:
