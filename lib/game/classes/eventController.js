            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Who were those people?' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Where did they take Dad?' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: '...' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Wait.' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Maybe it has something to do with this flash drive...' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'I should check it out on my computer.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
        ...
        event_LevelOne_PlayerAccessesFlashDrive: function () {
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ig.game.player.setMovementLock(true);
                    var dialogSetJSON = [
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Dad must have given me this software for a reason.' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'I remember him showing me some of his work in his room before.' },
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'I might be able to find some clues there.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
            ...
            this.eventChain = EventChain(this)
                .then(function ()
                {
                    ...
                    var dialogSetJSON = [
                        ...
                        { name: 'Justin', side: 'left' , mediaNum: 0, text: 'Are these the same people who took him?' },
                ...
                .then(function ()
                {
                    var dialogSetJSON = [
                        ...
                        { name: 'Police Officer', side: 'right' , mediaNum: 4, text: 'Yes Sir.' }
                    ];
                    this.dialogBox.playDialogSet(dialogSetJSON);
                })
                .waitUntil(function ()
