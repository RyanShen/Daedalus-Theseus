    ...
    .defines(function() {
        EntityProblemtrigger = ig.Entity.extend({
            ...
            update: function() {
                this.parent();
                if (!this.added) {
                    ig.game.questionController.add(this.name);
                    this.added = true;
                }
                if (this.locked) {
                        ...
                        case 1:
                            switch(this.eventStatus) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    if (this.after && !this.eventTriggered) {
                                        this.eventTriggered = true;
                                    ...
                                    break;
                                case 3:
                                    if ((!this.solved || this.key) && !this.eventTriggered && this.nextQuestion) {
            ...
            clickedOn: function() {
                ...
                this.destinationSet = false;
                return ig.input.mouse.x + ig.game.screen.x >= this.pos.x + this.xOffset - 80 &&
                    ig.input.mouse.x + ig.game.screen.x <= this.pos.x + this.xOffset + 180 &&
                    ig.input.mouse.y + ig.game.screen.y >= this.pos.y + this.yOffset - 80 &&
                    ig.input.mouse.y + ig.game.screen.y <= this.pos.y + this.yOffset + 180;
            },
