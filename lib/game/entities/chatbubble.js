ig.module(
  ...
  'impact.font'
    ...
    fontSize: 12,
    //Font color. [red,green,blue]. Only used if not using instance of ig.Font
    fontColor:[0,0,0],
    //Lifespan of the entity in seconds. 0 means permanent
    lifeSpan: 0,
    //Color of the chat bubble. [red,green,blue]
    color:[0,0,0],
    //Border color for the bubble. [red,green,blue] or null. No border is drawn if null
    borderColor: null,
    //Border width in pixels
    borderWidth: 0,
    //Opacity - 0.1 - 1
    opacity: '0.5',
    //Name of the entity chat bubble tracks.
    tracks: null,
    ...
    draw: function() {
	   ...
	   if ( follows ) {
		   ...
		   if ( this.shape == 'square' ) {
			   ...
			   /*
			   	Code to draw rectangles with rounded corners on HTML5 canvas by "Juan Mendes" from
