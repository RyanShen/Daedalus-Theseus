        ...
        updateObjectives: function(eventID) {
            switch (eventID){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    this.objectiveText = this.TextWrap('OBJECTIVE:\nGo to the front door to leave for the Police HQ when you are ready.', 100);
                    break;
                case 7:
                    this.objectiveText = this.TextWrap('OBJECTIVE:\nHelp police officers retrieve information from the pieces of evidence they are working on.', 100);
                    break;
                case 8:
                    this.objectiveText = this.TextWrap('OBJECTIVE:\nReport to Section Chief Steve\'s office.', 100);
                    break;
                case 10:
                    this.objectiveText = this.TextWrap('OBJECTIVE:\nDeactivate the SecurityBots.', 100);
                    break;
                case 11:
                    this.objectiveText = this.TextWrap('OBJECTIVE:\nHack into the lift\'s security system.', 100);
                    break;
                default:
                    this.objectiveText = this.TextWrap('OBJECTIVE:', 100);
                    break;
            }
