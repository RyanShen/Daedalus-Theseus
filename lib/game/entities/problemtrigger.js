ig.module(
    ...
    .defines(function() {
        EntityProblemtrigger = ig.Entity.extend({
            ...
            problemScore: 0,
            nextEvent: null,
            nextQuestion: null, // next format: q020304, q223970
            locked: true,
            eventID: -1,
            data: null,
                            ...
                            case 1:
                                switch (this.eventStatus) {
                                    ...
                                    case 3:
                                        ...
                                        ig.game.dataLoader.setProblemDisplayed(this.name);
                                        this.status = 4;
                                        break;
                                    default:
                                        break;
            ...
            unlock: function() {
                ...
                this.eventTriggered = ig.game.dataLoader.checkProblemDisplayed(this.name);
            ...
            unlockNextQuestions: function() {
                for(var i = 1; i < this.nextQuestion.length; i+=2) {
                    var nextItem = parseInt(this.nextQuestion.charAt(i) * 10) + parseInt(this.nextQuestion.charAt(i+1));
