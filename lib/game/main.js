...
MyGame = ig.Game.extend({
	...
	init: function() {
        ...
        //question interface
        this.qs = new QuestionInterface();
        this.qs.ProblemHide();
        ig.input.bind( ig.KEY.A, 'generate' );
        ig.input.bind( ig.KEY.S, 'kill' );
        ...
        this.spawnEntity( EntityDialogPlayer, 0, 0 );
	...
	update: function() {
        ...
        if (ig.input.pressed('generate')) {
            //ig.game.spawnEntity(EntityQuestions,50,20);
            var questions = ig.game.spawnEntity(EntityQuestions,50,0);
            questions.setQuestion('Enter the file system',75);
            this.qs.ProblemDisplay();
        }
	},
