        ...
        ig.EventController = ig.Class.extend({
            ...
            startEvent: function (eventTrigger) {
                ...
                switch (eventTrigger.eventID){
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        this.event_LevelThree_PlayerHacksElevator(eventTrigger);
                        break;
                    case 12:
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'ince computer security is not really our thing, you can start by helping some of the officers unlock information from the evidence they are working on.' },
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'MINOT-4... Minotaur?' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'Dad works at Crete Robotics Inc..' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'Based on the mythology, Daedalus created a labyrinth on Crete to house the Minotaur.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_thinking, autoprogress: 0, text: 'If we assume that the cyborg is the Minotaur, won\'t that mean Daedalus is at Crete!?' },
                    ...
                    .then(function ()
                    {
                        var dialogSetJSON = [
                            ...
                            { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'The kid\'s right. The phonecall came from Crete Robotics Inc.' },
            ...
            event_LevelThree_PlayerArrivesAtCreteRoboticsTower: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        var police = ig.game.getEntitiesByType('EntityNPC');

                        var police4WalkDestination = ig.game.getEntityByName('police1_walkDestination_1');
                        police[6].setDestination(police4WalkDestination.pos.x, police4WalkDestination.pos.y);
                        var police6WalkDestination = ig.game.getEntityByName('police2_walkDestination_1');
                        police[5].setDestination(police6WalkDestination.pos.x, police6WalkDestination.pos.y);
                        var police2WalkDestination = ig.game.getEntityByName('police3_walkDestination_1');
                        police[3].setDestination(police2WalkDestination.pos.x, police2WalkDestination.pos.y);
                        var police1WalkDestination = ig.game.getEntityByName('police4_walkDestination_1');
                        police[2].setDestination(police1WalkDestination.pos.x, police1WalkDestination.pos.y);
                        var police3WalkDestination = ig.game.getEntityByName('police5_walkDestination_1');
                        police[4].setDestination(police3WalkDestination.pos.x, police3WalkDestination.pos.y);
                        var police5WalkDestination = ig.game.getEntityByName('police6_walkDestination_1');
                        police[7].setDestination(police5WalkDestination.pos.x, police5WalkDestination.pos.y);
                    })
                    .wait(1)
                    .then(function ()
                    {
                    ...
                    .then(function ()
                    {
                        this.camera.entityToFollow = ig.game.player;
                        var dialogSetJSON = [
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Those look like trouble.' },
            ...
            event_LevelThree_PlayerHacksElevator: function () {
                this.dialogBox = ig.game.getEntitiesByType(EntityDialogPlayer)[0];
                this.camera = ig.game.levelController.camera;
                this.ends = false;
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Yes. Great job. Now let\'s head up the lift!' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Hmm.. Seems like they put a security lock on the lift. We can\'t get in.' },
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'Here. Let me have a look.' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
            ...
            event_LevelThree_PlayerHeadsToBossRoom: function () {
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'Alright! Good work.' },
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: '<nod>' }
                        ];
                        this.dialogBox.playDialogSet(dialogSetJSON);
                    })
                    .waitUntil(function ()
                    ...
                    {
                        ig.game.player.setMovementLock(false);
                        ig.game.levelController.loadLevel('3_Tower_TopFloor');
                        ig.game.inGameGUIController.updateObjectives(this.latestEventID);
                        this.ends = true;
                    })
            },
