...
.defines(function(){ "use strict";
    ...
    ig.InGameGUIController = ig.Class.extend({
        ...
        toggleUI: function( toggle ){
            ...
            {
                this.showUI = true;
                //console.trace("ui is open");
                ig.gui.element.action('showGroup', 'Group_IG');
            }
            else
            {
                this.showUI = false;
                //console.trace("ui is closed");
        ...
        update: function() {
            ...
            if( this.isHover == true && this.isHoverPre == false )
                //ig.game.audioController.play('GUI_Mouseover');
        ...
        updateObjectives: function(eventID) {
            ...
            switch (eventID){
                ...
                case '5':
                    ...
                    break;
                case '6':
                    this.objectiveText = this.TextWrap('Talk to Lisa at the front door.', wrapWidth);
                    break;
                case '7':
                ...
                case '9':
                    ...
                    break;
                case '10':
                    this.objectiveText = this.TextWrap('Deactivate the Security Bots.', wrapWidth);
                    break;
                case '11':
                    this.objectiveText = this.TextWrap('Enter the elevator.', wrapWidth);
                    break;
                case '12':
                    this.objectiveText = this.TextWrap('Destroy MINO-4.', wrapWidth);
                    break;
                case '13':
                    this.objectiveText = this.TextWrap('Talk to Dad.', wrapWidth);
                    break;
                case '14':
                    this.objectiveText = this.TextWrap('Solve as many questions as you can.', wrapWidth);
                    break;
                case '15':
                    this.objectiveText = this.TextWrap('Congratulations! You have completed PicoCTF 2014.', wrapWidth);
                    break;
