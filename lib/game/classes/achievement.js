...
ig.Achievement = ig.Class.extend({
       ...
       performAchievementChecks:function(){
           ...
           this.setAchievements(1,"achkey1","arrkey1","setarray1",1,6,9);
           this.setAchievements(2,"achkey2","arrkey2","setarray2",2,7,8);
           this.setAchievements(3,"achkey3","arrkey3","setarray3",2,3,4,5);
       },
       ...
       triggerAchievements:function(achID,achType,achName,achDesc,achKey,TextWrapperWidth,TextWidth,TextHeight){
        ...
        this.achievmentBox.setAchVariables(achName,achType,achDesc,TextWrapperWidth,TextWidth,TextHeight);
        var self = this;
        setTimeout(function(){
