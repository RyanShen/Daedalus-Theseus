...
.defines(function(){ "use strict";
    ...
    ig.LevelController = ig.Class.extend({
        ...
        loadGUIEntities: function() {
            ig.game.spawnEntity(EntityQuestionControl, 0, 0);
            ...
            switch(ig.game.eventController.latestEventID){
                ...
                case 9:
                    if (this.currentLevel == '3_Tower_GroundFloor'){
                        ...
                        var entityToaster1 = ig.game.spawnEntity(EntityNPC, spawnpointToaster1.pos.x, spawnpointToaster1.pos.y, {name:'SecurityBot 17', media:'Policeman'});
                        entityToaster1.orientation = 'down';

                        var spawnpointToaster2 = ig.game.getEntityByName('toasterSpawn_2');
                        var entityToaster2 = ig.game.spawnEntity(EntityNPC, spawnpointToaster2.pos.x, spawnpointToaster2.pos.y, {name:'SecurityBot 11', media:'Policeman'});
                        entityToaster2.orientation = 'down';
                    }
                    break;
                default :
