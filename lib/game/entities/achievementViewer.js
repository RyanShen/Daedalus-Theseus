ig.module(
    ...
    'impact.entity'
        ...
        EntityAchievementViewer = ig.Entity.extend({
            ...
            draw: function() {
                var ctxUI = ig.system.context;
                ctxUI.save();
                ctxUI.globalAlpha = this._alpha;
                ...
                for (var i = 1; i <= this.maxAchievementCount; i++) {
                    ...
                    if (!this.collection[i - 1]) {
                        ...
                        ctx.save();
                        if (ctxUI.globalAlpha > 0.4) {
                            ctx.globalAlpha = 0.4;
                        }
                        else {
                            ctx.globalAlpha = ctxUI.globalAlpha;
                        }
                ...
                ig.gui.element.action('getByName', 'Button_Back').alpha = this._alpha;
