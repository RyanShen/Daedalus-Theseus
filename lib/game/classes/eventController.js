    ...
    .defines(function(){ "use strict";
        ...
        ig.EventController = ig.Class.extend({
                ...
                this.eventChain = EventChain(this)
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: ig.game.dialogController.avatar[ig.game.avatarID].name, side: 'left' , mediaNum: ig.game.dialogFigures.f_hesitant, autoprogress: 0, text: 'It seems to be able to analyse objects that are either under corrupted or locked under a security system.' },
                ...
                this.eventChain = EventChain(this)
                    ...
                    .then(function ()
                    {
                        ...
                        var dialogSetJSON = [
                            ...
                            { name: 'Officer Lisa', side: 'right' , mediaNum: ig.game.dialogFigures.f_lisa, autoprogress: 0, text: 'WHAT!? Stop lying kid! TELL US WHERE IS HE HIDING!' },
            ...
            event_LevelThree_PlayerArrivesAtCreteRoboticsTower: function () {
                ...
                var policeman2 = ig.game.getEntityByName('Policeman1');
                var policeman3 = ig.game.getEntityByName('Policeman1');
                var policeman4 = ig.game.getEntityByName('Policeman1');
                var policeman5 = ig.game.getEntityByName('Policeman1');
                var policeman6 = ig.game.getEntityByName('Policeman1');
