        ...
        init: function() {
            ...
            this.dialogSetJSON= [
                ...
                {id: '2_PoliceHQ_Question11_After', content: [
                    { name: 'Policeman', side: 'right' , mediaNum: ig.game.dialogFigures.f_policeman2, autoprogress: 0, text: 'Ohhh! So that\'s how it\'s done.' },
                ...
                {id: '2_PoliceHQ_Steve', content: [
                    { name: 'Section Chief Steve', side: 'right' , mediaNum: ig.game.dialogFigures.f_steve, autoprogress: 0, text: 'How\'s the progress on the evidences, ' + this.avatar[ig.game.avatarID].name + '?'},
