    ...
    ig.LevelController = ig.Class.extend({
        ...
        loadNPCEntities: function() {
            if (this.currentLevel == '1_House_UpperFloor') {
                ...
                var spawnpointToaster1 = ig.game.getEntityByName('toasterSpawn_1');
                var entityToaster1 = ig.game.spawnEntity(EntityToaster, spawnpointToaster1.pos.x, spawnpointToaster1.pos.y, {name: 'SecurityBot 0000'});
                entityToaster1.speed = 100;

                var spawnpointToaster2 = ig.game.getEntityByName('toasterSpawn_2');
                var entityToaster2 = ig.game.spawnEntity(EntityToaster, spawnpointToaster2.pos.x, spawnpointToaster2.pos.y, {name: 'SecurityBot 0001'});
                entityToaster2.speed = 100;

                var spawnpointToaster3 = ig.game.getEntityByName('toasterSpawn_3');
                var entityToaster3 = ig.game.spawnEntity(EntityToaster, spawnpointToaster3.pos.x, spawnpointToaster3.pos.y, {name: 'SecurityBot 0010'});
                entityToaster3.speed = 100;

                var spawnpointToaster4 = ig.game.getEntityByName('toasterSpawn_4');
                var entityToaster4 = ig.game.spawnEntity(EntityToaster, spawnpointToaster4.pos.x, spawnpointToaster4.pos.y, {name: 'SecurityBot 0011'});
                entityToaster4.speed = 100;

                var spawnpointToaster5 = ig.game.getEntityByName('toasterSpawn_5');
                var entityToaster5 = ig.game.spawnEntity(EntityToaster, spawnpointToaster5.pos.x, spawnpointToaster5.pos.y, {name: 'SecurityBot 0100'});
                entityToaster5.speed = 100;

                var spawnpointToaster6 = ig.game.getEntityByName('toasterSpawn_6');
                var entityToaster6 = ig.game.spawnEntity(EntityToaster, spawnpointToaster6.pos.x, spawnpointToaster6.pos.y, {name: 'SecurityBot 0101'});
                entityToaster6.speed = 100;

                var spawnpointToaster7 = ig.game.getEntityByName('toasterSpawn_7');
                var entityToaster7 = ig.game.spawnEntity(EntityToaster, spawnpointToaster7.pos.x, spawnpointToaster7.pos.y, {name: 'SecurityBot 0111'});
                entityToaster7.speed = 100;

                var spawnpointToaster8 = ig.game.getEntityByName('toasterSpawn_8');
                var entityToaster8 = ig.game.spawnEntity(EntityToaster, spawnpointToaster8.pos.x, spawnpointToaster8.pos.y, {name: 'SecurityBot 1000'});
                entityToaster8.speed = 100;

                var spawnpointToaster9 = ig.game.getEntityByName('toasterSpawn_9');
                var entityToaster9 = ig.game.spawnEntity(EntityToaster, spawnpointToaster9.pos.x, spawnpointToaster9.pos.y, {name: 'SecurityBot 1001'});
                entityToaster9.speed = 100;

                var spawnpointToaster10 = ig.game.getEntityByName('toasterSpawn_10');
                var entityToaster10 = ig.game.spawnEntity(EntityToaster, spawnpointToaster10.pos.x, spawnpointToaster10.pos.y, {name: 'SecurityBot 1010'});
