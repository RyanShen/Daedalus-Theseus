...
EntityDialogPlayer = ig.Entity.extend({
    ...
    init: function(){
        ...
        this.dialogBox = ig.game.spawnEntity( EntityDialogBox, 202, 600 );

        this.dialogFigures.push( ig.game.spawnEntity( EntityDialogFigure, 0, 0 ) );
        this.dialogFigures.push( ig.game.spawnEntity( EntityDialogFigure, 0, 0 ) );
    },

    skipCurrentDialog: function(){
        this.dialogJSON = [];
    ...
    update: function(){
        ...
        if (ig.input.pressed('skip') && this.isPlaying == true)
        {
        ...
        if( this.dialogBox._finished )
        {
            ...
            {
                this.playDialogFigure( 'noside', null, null, null, 0 );
